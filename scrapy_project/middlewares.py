...
class ScrapeOpsFakeBrowserHeaderAgentMiddleware:
    ...
    def process_request(self, request, spider):
        ...
        # Only set headers that exist in the random_browser_header
        for header_name in [
            'accept-language',
            'sec-fetch-user',
            'sec-fetch-mode',
            ...
            if header_name in random_browser_header:
                request.headers[header_name] = random_browser_header[header_name]
